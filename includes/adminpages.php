...
function pmpro_display_post_states( $post_states, $post ) {
	...
	if ( intval( $pmpro_pages['consult'] ) === $post->ID ) {
		$post_states['pmpro_consult_page'] = __( 'Membership Consult Page', 'paid-memberships-pro' );
	}

	if ( intval( $pmpro_pages['refund'] ) === $post->ID ) {
		$post_states['pmpro_refund_page'] = __( 'Membership Refund Page', 'paid-memberships-pro' );
	}

	if ( intval( $pmpro_pages['requestnewrefund'] ) === $post->ID ) {
		$post_states['pmpro_requestnewrefund_page'] = __( 'Membership Request New Refund Page', 'paid-memberships-pro' );
	}
